...
import {  PointsMaterial, Box3, Vector3, PerspectiveCamera } from "three";
...
function PointCloudModel(prop : {filePath:string})
{
  ...
  return (
    <points geometry={result.geometry} material={material} />
  );
}
  ...
  return (
    <div id="canvas-container" className="canvas-container">
     ...
     <input
      ...
      <Canvas flat linear>
        <OrbitControls />
        {fileUrl && (<PointCloudModel filePath={fileUrl} />)}
      </Canvas>
    </div>
  );
}
